  ...
  <a href="dashboard.php">Dashboard</a>
   ...
   <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="studentdelete.php">Employment Student</a>
      <a href="coursedelete.php">Course</a>
    </div>
  </div>

      <a href="updatecourseprocess.php">Course</a>
   
  <div class="dropdown">
    <button class="button">Alumni Information</button>
    <div class="dropdown-content">
      <a href="viewstudent.php">Employment Student</a>
      <a href="viewcourse.php">Course</a>
      <a href="viewemployment.php">UnEmployment Student</a>
    </div>
  </div>
